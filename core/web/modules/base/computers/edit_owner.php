...
if (isset($_POST["bconfirm"])) {
	...
	changeOwnerOfComputer($uuid, $new_owner);
    ...
    $f = new PopupForm(_("Owner"));
    $f->push(new Table());

    $sel = new SelectItem("new_owner");
    $sel->setElements(get_users());
    //$sel->setSelected(qqq);
    $tr = new TrFormElement(_("Select a new owner of computer"), $sel, array("value" => ''));
